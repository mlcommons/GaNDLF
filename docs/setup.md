...
conda activate ./venv
conda install pytorch torchvision torchaudio cudatoolkit=10.2 -c pytorch -y # install according to your cuda version https://pytorch.org/get-started/locally/
