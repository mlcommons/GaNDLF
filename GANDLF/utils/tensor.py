...
def send_model_to_device(
    ...
    device,
    optimizer_1,
    optimizer_2: Union[torch.optim.Optimizer, None] = None,
):
    """
    ...
    Args:
        ...
        optimizer_1 (torch.optim): The optimizer for training.
        optimizer_2 (torch.optim, optional): The second optimizer. Used in case of GANs. Defaults to None.
