...
from GANDLF.computeGAN.step2 import step
from .loss_and_metric import get_loss_and_metrics


def validate_network(
    model_main, valid_dataloader, scheduler_list, params, epoch=0, mode="validation"
):
    """
    ...
    for batch_idx, (subject) in enumerate(
        ...
        if ("value_keys" in params) and label_present:
            ...
            for patches_batch in patch_loader:
                ...
                result = step(model_main, image, label, params)
