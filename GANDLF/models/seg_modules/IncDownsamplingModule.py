...
class IncDownsamplingModule(nn.Module):
    def __init__(
        ...
        Args:
            ...
            conv_bias (bool, optional): Whether to include a bias term in the 1x1 convolution layer. Defaults to True.
            inst_norm_affine (bool, optional): Whether to include an affine transform in the instance normalization layer. Defaults to True.
            lrelu_inplace (bool, optional): Whether to use the input tensor for the output of the leaky ReLU activation function. Defaults to True.
        """
