...
class IncDownsamplingModule(nn.Module):
    def __init__(
        ...
        Args:
            input_channels (int):
                The number of input channels in the tensor.
            output_channels (int):
                The number of output channels in the tensor.
            Conv (torch.nn.Module):
                The type of convolution layer to use.
            Dropout (torch.nn.Module):
                The type of dropout layer to use.
            InstanceNorm (torch.nn.Module):
                The type of instance normalization layer to use.
            leakiness (float, optional):
                The negative slope of the leaky ReLU activation function. Defaults to 1e-2.
            kernel_size (int, optional):
                The kernel size of the 1x1 convolution layer. Defaults to 1.
            conv_bias (bool, optional):
                Whether to include a bias term in the 1x1 convolution layer. Defaults to True.
            inst_norm_affine (bool, optional):
                Whether to include an affine transform in the instance normalization layer. Defaults to True.
            lrelu_inplace (bool, optional):
                Whether to use the input tensor for the output of the leaky ReLU activation function. Defaults to True.
        """
