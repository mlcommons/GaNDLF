...
from GANDLF.models.seg_modules.add_downsample_conv_block import add_downsample_conv_block
...
class Decoder(ModelBase):
    def __init__(self, 
        ...
        self.layer_list = add_conv_block(self.Conv, self.BatchNorm, in_ch=anatomy_factors, out_ch=base_filters)
...
class Segmentor(ModelBase):
    def __init__(self,
        ...
        self.layer_list = add_conv_block(self.Conv, self.BatchNorm, in_ch=anatomy_factors, out_ch=base_filters*4)
        self.layer_list += add_conv_block(self.Conv, self.BatchNorm, in_ch=base_filters*4, out_ch=base_filters*4)
...
class ModalityEncoder(ModelBase):
    def __init__(self, 
        ...
        self.num_layers = num_layers
        self.layer_list = add_downsample_conv_block(self.Conv, self.BatchNorm, in_ch=anatomy_factors+1, out_ch=16)
...
class SDNet(ModelBase):
    ...
    def forward(self,
        ...
        return sm, reco, mu, logvar, modality_factors_reencoded #sm, anatomy_factors, mu, logvar, modality_factors_reencoded