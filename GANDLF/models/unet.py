...
class unet(ModelBase):
    ...
    def __init__(self, n_dimensions, n_channels, n_classes, base_filters, final_convolution_layer):
        ...
        self.de_3 = DecodingModule(base_filters*16, base_filters*8, self.Convolution, self.Dropout, self.InstanceNorm)
        self.us_2 = UpsamplingModule(base_filters*8, base_filters*4, self.Convolution, self.Dropout, self.InstanceNorm)
        self.de_2 = DecodingModule(base_filters*8, base_filters*4, self.Convolution, self.Dropout, self.InstanceNorm)
