...
class resunet(ModelBase):
    """
    This is the standard U-Net architecture : https://arxiv.org/pdf/1606.06650.pdf - with the
    residual connections. The Downsampling, Encoding, Decoding modules are defined in the
    seg_modules file. These smaller modules are basically defined by 2 parameters, the input
    channels (filters) and the output channels (filters), and some other hyperparameters,
    ...
    def __init__(self, n_dimensions, n_channels, n_classes, base_filters, final_convolution_layer):
        ...
        self.ins = in_conv(self.n_channels, base_filters, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.ds_0 = DownsamplingModule(base_filters, base_filters*2)
        self.en_1 = EncodingModule(base_filters*2, base_filters*2, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.ds_1 = DownsamplingModule(base_filters*2, base_filters*4, self.Convolution, self.Dropout, self.InstanceNorm)
        self.en_2 = EncodingModule(base_filters*4, base_filters*4, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.ds_2 = DownsamplingModule(base_filters*4, base_filters*8, self.Convolution, self.Dropout, self.InstanceNorm)
        self.en_3 = EncodingModule(base_filters*8, base_filters*8, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.ds_3 = DownsamplingModule(base_filters*8, base_filters*16, self.Convolution, self.Dropout, self.InstanceNorm)
        self.en_4 = EncodingModule(base_filters*16, base_filters*16, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.us_3 = UpsamplingModule(base_filters*16, base_filters*8, self.Convolution, self.Dropout, self.InstanceNorm)
        self.de_3 = DecodingModule(base_filters*16, base_filters*8, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.us_2 = UpsamplingModule(base_filters*8, base_filters*4, self.Convolution, self.Dropout, self.InstanceNorm)
        self.de_2 = DecodingModule(base_filters*8, base_filters*4, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.us_1 = UpsamplingModule(base_filters*4, base_filters*2, self.Convolution, self.Dropout, self.InstanceNorm)
        self.de_1 = DecodingModule(base_filters*4, base_filters*2, self.Convolution, self.Dropout, self.InstanceNorm, res=True)
        self.us_0 = UpsamplingModule(base_filters*2, base_filters, self.Convolution, self.Dropout, self.InstanceNorm)
        self.out = out_conv(base_filters*2, n_classes, self.Convolution, self.Dropout, self.InstanceNorm,
