...
save_path = "/cbica/home/bhaleram/comp_space/brets/new_scripts/ResUNet/Exp_1/gen_seg/gen_test_2/stored_outputs_test/"
model_path1 = "/cbica/home/bhaleram/comp_space/brets/model/ResUNet/Exp_1/mod2404.pt"
...
img1 = img[:,:,0:144,0:144,:]
img2 = img[:,:,0:144,y-144:y,:]
img3 = img[:,:,x-144:x,0:144,:]
img4 = img[:,:,x-144:x,y-144:y,:]

seg_pred1 = model1(img1.float())
seg_pred2 = model1(img2.float())
seg_pred3 = model1(img3.float())
seg_pred4 = model1(img4.float())

seg_pred = np.zeros((1,1,x,y,z),dtype=float)
seg_pred[:,:,0:144,0:144,:] = seg_pred1[:,0,:,:,:].cpu().detach().numpy()
seg_pred[:,:,0:144,y-144:y,:] = seg_pred2[:,0,:,:,:].cpu().detach().numpy()
seg_pred[:,:,x-144:x,0:144,:] = seg_pred3[:,0,:,:,:].cpu().detach().numpy()
seg_pred[:,:,x-144:x,y-144:y,:] = seg_pred4[:,0,:,:,:].cpu().detach().numpy()
...
nib.save(seg_new, save_path + patient_name + "_2.nii.gz")
