...
def trainingLoop(train_loader_pickle, val_loader_pickle, 
  ...
  trainingDataForTorch = ImagesFromDataFrame(trainingDataFromPickle, psize, channelHeaders, labelHeader, patch_size = psize, augmentations)
  validationDataForTorch = ImagesFromDataFrame(validataionDataFromPickle, psize, channelHeaders, labelHeader, patch_size = psize, augmentations) # may or may not need to add augmentations here
